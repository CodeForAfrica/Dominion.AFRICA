      ...
      <Page>
        ...
        <Section title="What's the data behind the story?" subtitle="">
          <Typography style={{ fontWeight: 800 }}>
            ...
            sourcing, cleaning and adding data sets to this site, and work
            towards becoming the authoritative data source on this issue.
          </Typography>
          <br />
          <Typography style={{ fontWeight: 800 }}>
            HURUmap Land provides useful facts and data about land ownership in
            South Africa. Compare places using tables and maps, download data,
            and embed charts on your site
          </Typography>
          <br />
          <Typography>
            HURUmap’s underlying data is quality-checked, from reputable
            official sources including the government Census, PEPFAR and Uwezo.
            This project is build on software originally created by the Knight
            Lab in the U.S.A. for their CensusReporter.org project, which has
            been repurposed by OpenUp and Media Monitoring Africa for Wazimap in
            South Africa and by Code for Africa for HURUmap in Kenya, Tanzania,
            Uganda and Zambia.
          </Typography>
          <br />
          <Typography style={{ fontWeight: 800 }}>
